...
import { ActivityIcon, DropletIcon, ScaleIcon, UserIcon } from "lucide-react";
import Image from "next/image";
import { useEffect, useState } from "react";
import { AppointmentCard } from "../../../../../components/patient-profile/appointment-card";
import { ImageViewerModal } from "../../../../../components/patient-profile/image-view-modal";
import { PastAppointmentCard } from "../../../../../components/patient-profile/past-appointment-card";
import { StatCard } from "../../../../../components/patient-profile/start-card";
import AddMedicalRecordModal from "./add-medical-records";
...
export const PatientDashboard = () => {
  ...
  const onUploadSuccess = () => {
    ...
    // 1. Refresh your medical records list
    // 2. Show a success notification
    // 3. Reset any related states
  };
  ...
  return (
    <div className="border rounded-md relative  ">
      {/* Patient Header */}
      <div className="  flex flex-col md:flex-row gap-6 mb-8 border-b">
